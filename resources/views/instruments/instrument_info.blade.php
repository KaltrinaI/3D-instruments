...
<div class="container d-block">
    ...
    <div class="container col-lg-12 text-center pt-4">
        <div class="btn text-monospace text-center text-dark">
            <a class="btn-text" style="text-decoration: none" href="{{action('App\Http\Controllers\InstrumentController@instruments', $instrument['instrument_family'])}}"><span>Go back</span></a>
        </div>
    </div>
